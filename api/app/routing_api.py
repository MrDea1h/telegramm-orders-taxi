...
from shared.yandex_maps import geocode, haversine_km, route_eta_seconds
...
class EtaOut(BaseModel):
    ...
    distance_km: float
    is_estimated: bool
    source: Literal["yandex", "fallback"]
...
async def eta(body: EtaRequest, _user: User = Depends(require_verified)) -> EtaOut:
    ...
    if seconds is not None:
        ...
        return EtaOut(
            duration_min=duration_min, distance_km=distance_km, is_estimated=False, source="yandex"
        )
