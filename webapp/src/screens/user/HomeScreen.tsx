...
export function HomeScreen() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* Pull-to-refresh only wraps the scrollable content below the header
          — wrapping the header too made it visually shift down mid-pull,
          which left the loading indicator looking stuck at the header's
          bottom edge instead of sitting where the user actually pulled. */}
      <PullToRefresh
        className="-mt-5 flex-1 pb-28"
              ...
              >
                <div className="cursor-pointer p-4">
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    <div>
                      <p className="text-[14px] font-medium text-[var(--tg-text)]">{nextOrder.from_address}</p>
                      <p className="text-[12px] text-[var(--tg-text-secondary)]">→ {nextOrder.to_address}</p>
                    </div>
